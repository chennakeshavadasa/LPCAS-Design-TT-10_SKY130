...
N 330 -350 390 -350 {lab=VDD}
N 390 -310 390 -280 {lab=GND}
N 690 -350 770 -350 {lab=Vref}
N 740 -350 740 -300 {lab=Vref}
...
C {code_shown.sym} 0 -620 0 0 {name=NGSPICE only_toplevel=false value="
...
C {vdd.sym} 330 -350 0 0 {name=l1 lab=VDD}
C {gnd.sym} 390 -280 0 0 {name=l2 lab=GND}
C {capa.sym} 740 -270 0 0 {name=C1
m=1
value=10n
footprint=1206
device="ceramic capacitor"}
C {gnd.sym} 740 -210 0 0 {name=l3 lab=GND}
C {lab_pin.sym} 770 -350 0 1 {name=p1 sig_type=std_logic lab=Vref}
